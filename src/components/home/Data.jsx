...
const Data = () => {
    ...
    return (
        <div className="home__data">
            <p><span className='introduction'>┣┫Ё┗└ О, my name is</span></p>
            <h1 className="home__title">Shubham Jain
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className='home__subtitle'>I'm a <span style={{ whiteSpace: 'pre' }} className="typed" ref={el} ></span>
                {/* <Typewriter
                    options={{
                        autoStart: true,
                        loop: true,
            ...
            <p className="home__description"> Based in Kolkata, and I'm very passionate and dedicated to my work.</p>
